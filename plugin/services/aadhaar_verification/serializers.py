...
class AadhaarOTPGenerateRequestSerializer(serializers.Serializer):
    ...
    purpose = serializers.CharField(
        default="ForKYC",
        help_text="Purpose of verification"
    )
...
class AadhaarOTPVerifyRequestSerializer(serializers.Serializer):
    ...
    reference_id = serializers.CharField(
        required=True,
        help_text="Reference ID from generate OTP step"
    )
    ...
    generate_pdf = serializers.BooleanField(
        default=False,
        help_text="Generate PDF document"
    )
...
class AadhaarVerificationResponseSerializer(serializers.Serializer):
    ...
    masked_number = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    name = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    date_of_birth = serializers.CharField(required=False, allow_null=True, allow_blank=True)
    ...
    photo = serializers.CharField(required=False, allow_null=True, allow_blank=True)  # Base64 encoded
    document_pdf = serializers.CharField(required=False, allow_null=True, allow_blank=True)  # Base64 encoded PDF
    aadhaar_linked_mobile_match = serializers.CharField(required=False, allow_null=True, allow_blank=True)  # Yes/No
