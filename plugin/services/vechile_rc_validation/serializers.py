...
class VehicleRCVerificationRequestSerializer(serializers.Serializer):
    rc_number = serializers.CharField(help_text="RC number for advanced verification")
...
class VehicleRCVerificationResponseSerializer(serializers.Serializer):
    ...
    vehicle_registration_date = serializers.DateTimeField(
    ...
    maker_description = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    ...
    vehicle_fuel_type = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    vehicle_color = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    norms_type = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    ...
    manufactured_month_year = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    ...
    noc_details = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    ...
    national_permit_number = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    national_permit_issued_by = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    national_permit_valid_from = serializers.DateTimeField(
        required=False, allow_null=True
    )
    national_permit_valid_upto = serializers.DateTimeField(
        required=False, allow_null=True
    )
    ...
    puc_number = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    puc_valid_upto = serializers.DateTimeField(required=False, allow_null=True)
    masked_aadhaar_number = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
    masked_mobile_number = serializers.CharField(
        required=False, allow_blank=True, allow_null=True
    )
