...
class VehicleRCVerificationResponseSerializer(serializers.Serializer):
    ...
    maker_model = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    ...
    insurance_policy_number = serializers.CharField(required=False, allow_blank=True, allow_null=True)
